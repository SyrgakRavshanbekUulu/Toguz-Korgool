...
{
    public Text whitGamerName;
    public Text blackGamerName;
    ...
    public int Kaz1Size;
    public int Kaz2Size;
    public int lastIndex, HomePosition1 = -100, HomePosition2 = -100, moveIndex, botMove;
    private float yPos = 3.7f;
    public GameObject dfg, gameOver;
    ...
    MeshRenderer myrend;
    public bool botSelect = false, botmoving = false, whiteBot = false, blackBot = false;
    ...
    void Update()
    {
        if(GetComponent<Gamers>().wbot == true)
        {
            whiteBot = true;
            blackBot = false;
            botSelect = true;
        }
        else if(GetComponent<Gamers>().bbot == true)
        {
            blackBot = true;
            whiteBot = false;
            botSelect = true;
        }
        if(GetComponent<Gamers>().panel.activeSelf == false)
        {
            
        if(whiteGamer == true)
        {
            whitGamerName.GetComponent<Animator>().enabled = true;
            blackGamerName.GetComponent<Animator>().enabled = false;
        }
        else if(blackGamer == true)
        {
            whitGamerName.GetComponent<Animator>().enabled = false;
            blackGamerName.GetComponent<Animator>().enabled = true;
        }
        //KorgoolsMoving(not,animationPos);
        if(Kaz1Size > 81)
        {
            GetComponent<gameOver>().woner.text = whitGamerName.text;
            gameOver.SetActive(true);
        }
        else if(Kaz2Size > 81)
        {
            GetComponent<gameOver>().woner.text = blackGamerName.text;  
            gameOver.SetActive(true);
        }
        else if(Kaz2Size == 81 && Kaz1Size == 81)
        {
            GetComponent<gameOver>().woner.text = " Достук ";
            gameOver.SetActive(true);
        }
        else if(Input.GetMouseButtonDown(0))
         {
             ...
             {
                 if(botSelect == true && blackBot == true && blackGamer == true)
                 {
                    botMove = GetComponent<Bot>().bmaxPoint();
                    if(botMove == 9) selecObj = Korgool10[0];
                    else if(botMove == 10) selecObj = Korgool11[0];
                    else if(botMove == 11) selecObj = Korgool12[0];
                    else if(botMove == 12) selecObj = Korgool13[0];
                    else if(botMove == 13) selecObj = Korgool14[0];
                    else if(botMove == 14) selecObj = Korgool15[0];
                    else if(botMove == 15) selecObj = Korgool16[0];
                    else if(botMove == 16) selecObj = Korgool17[0];
                    else if(botMove == 17) selecObj = Korgool18[0];
                 }
                 else if(botSelect == true && whiteBot == true && whiteGamer == true)
                 {
                    botMove = GetComponent<Bot>().wmaxPoint();
                    if(botMove == 0) selecObj = Korgool1[0];
                    else if(botMove == 1) selecObj = Korgool2[0];
                    else if(botMove == 2) selecObj = Korgool3[0];
                    else if(botMove == 3) selecObj = Korgool4[0];
                    else if(botMove == 4) selecObj = Korgool5[0];
                    else if(botMove == 5) selecObj = Korgool6[0];
                    else if(botMove == 6) selecObj = Korgool7[0];
                    else if(botMove == 7) selecObj = Korgool8[0];
                    else if(botMove == 8) selecObj = Korgool9[0];
                 }
                 else 
                 {
                    selecObj = hit.transform.gameObject;
                 }
                     ...
                     {   
                        if((het.transform.gameObject == dfg && SelObj[0] != null))
                        {
                          ...
                          if(whiteGamer == true)
                          {
                            whiteGamer = false;
                            blackGamer = true;
                            if(whiteBot == true && botSelect == true)
                            {
                                botSelect = false;
                            }
                            else if(whiteBot == true && botSelect == false)
                            {
                                botSelect = true;
                            }
                          ...
                          else if(blackGamer == true)
                          {
                            whiteGamer = true;
                            blackGamer = false;
                            if(blackBot == true && botSelect == true)
                            {
                                botSelect = false;
                            }
                            else if(blackBot == true && botSelect == false)
                            {
                                botSelect = true;
                            }
                          }
    ...
    public GameObject[] SectorElements(Vector3[] secPos, int maxElement)
    {
        ...
        for (int i = 0; i < maxElement; i++)
        {
            ...
            {
               r[i] = Instantiate(korgool, secPos[i - 30], Quaternion.identity) as GameObject; 
            }
        }
        return r;
    }
